...
.method public build()Lcom/karumi/dexter/listener/multi/DialogOnAnyDeniedMultiplePermissionsListener;
    ...
    iget-object v1, p0, Lcom/karumi/dexter/listener/multi/DialogOnAnyDeniedMultiplePermissionsListener$Builder;->context:Landroid/content/Context;

    iget-object v5, p0, Lcom/karumi/dexter/listener/multi/DialogOnAnyDeniedMultiplePermissionsListener$Builder;->icon:Landroid/graphics/drawable/Drawable;

    const/4 v6, 0x0

    invoke-direct/range {v0 .. v6}, Lcom/karumi/dexter/listener/multi/DialogOnAnyDeniedMultiplePermissionsListener;-><init>(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/graphics/drawable/Drawable;Lcom/karumi/dexter/listener/multi/DialogOnAnyDeniedMultiplePermissionsListener$1;)V

    return-object v0

    :cond_0
    iget-object v2, p0, Lcom/karumi/dexter/listener/multi/DialogOnAnyDeniedMultiplePermissionsListener$Builder;->title:Ljava/lang/String;

    goto :goto_0

    :cond_1
    iget-object v3, p0, Lcom/karumi/dexter/listener/multi/DialogOnAnyDeniedMultiplePermissionsListener$Builder;->message:Ljava/lang/String;

    goto :goto_1

    :cond_2
    iget-object v4, p0, Lcom/karumi/dexter/listener/multi/DialogOnAnyDeniedMultiplePermissionsListener$Builder;->buttonText:Ljava/lang/String;
...
.method public withButtonText(I)Lcom/karumi/dexter/listener/multi/DialogOnAnyDeniedMultiplePermissionsListener$Builder;
    ...
    iput-object v0, p0, Lcom/karumi/dexter/listener/multi/DialogOnAnyDeniedMultiplePermissionsListener$Builder;->buttonText:Ljava/lang/String;
...
.method public withIcon(I)Lcom/karumi/dexter/listener/multi/DialogOnAnyDeniedMultiplePermissionsListener$Builder;
    ...
    iput-object v0, p0, Lcom/karumi/dexter/listener/multi/DialogOnAnyDeniedMultiplePermissionsListener$Builder;->icon:Landroid/graphics/drawable/Drawable;
...
.method public withMessage(I)Lcom/karumi/dexter/listener/multi/DialogOnAnyDeniedMultiplePermissionsListener$Builder;
    ...
    iput-object v0, p0, Lcom/karumi/dexter/listener/multi/DialogOnAnyDeniedMultiplePermissionsListener$Builder;->message:Ljava/lang/String;
...
.method public withTitle(I)Lcom/karumi/dexter/listener/multi/DialogOnAnyDeniedMultiplePermissionsListener$Builder;
    ...
    iput-object v0, p0, Lcom/karumi/dexter/listener/multi/DialogOnAnyDeniedMultiplePermissionsListener$Builder;->title:Ljava/lang/String;
