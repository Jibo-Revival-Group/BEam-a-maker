...
.method constructor <init>(Landroid/content/Context;Lcom/karumi/dexter/AndroidPermissionService;Lcom/karumi/dexter/IntentProvider;)V
    ...
    iput-object v0, p0, Lcom/karumi/dexter/DexterInstance;->pendingPermissions:Ljava/util/Collection;
    ...
    iput-object v0, p0, Lcom/karumi/dexter/DexterInstance;->multiplePermissionsReport:Lcom/karumi/dexter/MultiplePermissionsReport;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    iput-object v0, p0, Lcom/karumi/dexter/DexterInstance;->isRequestingPermission:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    iput-object v0, p0, Lcom/karumi/dexter/DexterInstance;->rationaleAccepted:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    iput-object v0, p0, Lcom/karumi/dexter/DexterInstance;->isShowingNativeDialog:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method private checkNoDexterRequestOngoing()V
    ...
    sget-object v2, Lcom/karumi/dexter/listener/DexterError;->REQUEST_ONGOING:Lcom/karumi/dexter/listener/DexterError;

    invoke-direct {v0, v1, v2}, Lcom/karumi/dexter/DexterException;-><init>(Ljava/lang/String;Lcom/karumi/dexter/listener/DexterError;)V
...
.method private checkRequestSomePermission(Ljava/util/Collection;)V
    ...
    sget-object v2, Lcom/karumi/dexter/listener/DexterError;->NO_PERMISSIONS_REQUESTED:Lcom/karumi/dexter/listener/DexterError;
...
.method private checkSinglePermission(Lcom/karumi/dexter/listener/single/PermissionListener;Ljava/lang/String;Lcom/karumi/dexter/Thread;)V
    ...
    invoke-direct {p0, v0, v1, p3}, Lcom/karumi/dexter/DexterInstance;->checkMultiplePermissions(Lcom/karumi/dexter/listener/multi/MultiplePermissionsListener;Ljava/util/Collection;Lcom/karumi/dexter/Thread;)V
...
.method private getPermissionStates(Ljava/util/Collection;)Lcom/karumi/dexter/DexterInstance$PermissionStates;
    ...
    new-instance v1, Lcom/karumi/dexter/DexterInstance$PermissionStates;

    const/4 v0, 0x0

    invoke-direct {v1, p0, v0}, Lcom/karumi/dexter/DexterInstance$PermissionStates;-><init>(Lcom/karumi/dexter/DexterInstance;Lcom/karumi/dexter/DexterInstance$1;)V
    ...
    invoke-direct {p0, v3, v0}, Lcom/karumi/dexter/DexterInstance;->checkSelfPermission(Landroid/app/Activity;Ljava/lang/String;)I

    move-result v3

    packed-switch v3, :pswitch_data_0

    invoke-static {v1, v0}, Lcom/karumi/dexter/DexterInstance$PermissionStates;->access$500(Lcom/karumi/dexter/DexterInstance$PermissionStates;Ljava/lang/String;)V

    goto :goto_0

    :pswitch_0
    invoke-static {v1, v0}, Lcom/karumi/dexter/DexterInstance$PermissionStates;->access$300(Lcom/karumi/dexter/DexterInstance$PermissionStates;Ljava/lang/String;)V

    goto :goto_0

    :pswitch_1
    invoke-static {v1, v0}, Lcom/karumi/dexter/DexterInstance$PermissionStates;->access$400(Lcom/karumi/dexter/DexterInstance$PermissionStates;Ljava/lang/String;)V
...
.method private handleDeniedPermissions(Ljava/util/Collection;)V
    ...
    invoke-virtual {v3, v4, v0}, Lcom/karumi/dexter/AndroidPermissionService;->shouldShowRequestPermissionRationale(Landroid/app/Activity;Ljava/lang/String;)Z
    ...
    invoke-direct {v3, v0}, Lcom/karumi/dexter/listener/PermissionRequest;-><init>(Ljava/lang/String;)V
    ...
    new-instance v0, Lcom/karumi/dexter/PermissionRationaleToken;

    invoke-direct {v0, p0}, Lcom/karumi/dexter/PermissionRationaleToken;-><init>(Lcom/karumi/dexter/DexterInstance;)V

    iget-object v2, p0, Lcom/karumi/dexter/DexterInstance;->listener:Lcom/karumi/dexter/listener/multi/MultiplePermissionsListener;

    invoke-interface {v2, v1, v0}, Lcom/karumi/dexter/listener/multi/MultiplePermissionsListener;->onPermissionRationaleShouldBeShown(Ljava/util/List;Lcom/karumi/dexter/PermissionToken;)V
...
.method private isEveryPermissionGranted(Ljava/util/Collection;Landroid/content/Context;)Z
    ...
    invoke-virtual {v2, p2, v0}, Lcom/karumi/dexter/AndroidPermissionService;->checkSelfPermission(Landroid/content/Context;Ljava/lang/String;)I
...
.method private onPermissionsChecked(Ljava/util/Collection;)V
    ...
    :cond_0
    iget-object v1, p0, Lcom/karumi/dexter/DexterInstance;->pendingPermissionsMutex:Ljava/lang/Object;
    ...
    iget-object v0, p0, Lcom/karumi/dexter/DexterInstance;->listener:Lcom/karumi/dexter/listener/multi/MultiplePermissionsListener;

    sget-object v2, Lcom/karumi/dexter/DexterInstance;->EMPTY_LISTENER:Lcom/karumi/dexter/listener/multi/MultiplePermissionsListener;

    iput-object v2, p0, Lcom/karumi/dexter/DexterInstance;->listener:Lcom/karumi/dexter/listener/multi/MultiplePermissionsListener;
    ...
    invoke-interface {v0, v2}, Lcom/karumi/dexter/listener/multi/MultiplePermissionsListener;->onPermissionsChecked(Lcom/karumi/dexter/MultiplePermissionsReport;)V
...
.method private requestPermissionsToSystem(Ljava/util/Collection;)V
    ...
    invoke-virtual {v1, v2, v0, v3}, Lcom/karumi/dexter/AndroidPermissionService;->requestPermissions(Landroid/app/Activity;[Ljava/lang/String;I)V
...
.method private updatePermissionsAsDenied(Ljava/util/Collection;)V
    ...
    invoke-virtual {v1, v3, v0}, Lcom/karumi/dexter/AndroidPermissionService;->shouldShowRequestPermissionRationale(Landroid/app/Activity;Ljava/lang/String;)Z
    ...
    :goto_1
    invoke-static {v0, v1}, Lcom/karumi/dexter/listener/PermissionDeniedResponse;->from(Ljava/lang/String;Z)Lcom/karumi/dexter/listener/PermissionDeniedResponse;
    ...
    invoke-virtual {v1, v0}, Lcom/karumi/dexter/MultiplePermissionsReport;->addDeniedPermissionResponse(Lcom/karumi/dexter/listener/PermissionDeniedResponse;)Z
...
.method private updatePermissionsAsGranted(Ljava/util/Collection;)V
    ...
    invoke-static {v0}, Lcom/karumi/dexter/listener/PermissionGrantedResponse;->from(Ljava/lang/String;)Lcom/karumi/dexter/listener/PermissionGrantedResponse;

    move-result-object v0

    iget-object v2, p0, Lcom/karumi/dexter/DexterInstance;->multiplePermissionsReport:Lcom/karumi/dexter/MultiplePermissionsReport;

    invoke-virtual {v2, v0}, Lcom/karumi/dexter/MultiplePermissionsReport;->addGrantedPermissionResponse(Lcom/karumi/dexter/listener/PermissionGrantedResponse;)Z
...
.method onActivityReady(Landroid/app/Activity;)V
    ...
    invoke-direct {p0, v0}, Lcom/karumi/dexter/DexterInstance;->getPermissionStates(Ljava/util/Collection;)Lcom/karumi/dexter/DexterInstance$PermissionStates;
    ...
    invoke-static {v0}, Lcom/karumi/dexter/DexterInstance$PermissionStates;->access$000(Lcom/karumi/dexter/DexterInstance$PermissionStates;)Ljava/util/Collection;

    move-result-object v1

    invoke-direct {p0, v1}, Lcom/karumi/dexter/DexterInstance;->handleDeniedPermissions(Ljava/util/Collection;)V

    invoke-virtual {v0}, Lcom/karumi/dexter/DexterInstance$PermissionStates;->getImpossibleToGrantPermissions()Ljava/util/Collection;

    move-result-object v1

    invoke-direct {p0, v1}, Lcom/karumi/dexter/DexterInstance;->updatePermissionsAsDenied(Ljava/util/Collection;)V

    invoke-static {v0}, Lcom/karumi/dexter/DexterInstance$PermissionStates;->access$100(Lcom/karumi/dexter/DexterInstance$PermissionStates;)Ljava/util/Collection;

    move-result-object v0

    invoke-direct {p0, v0}, Lcom/karumi/dexter/DexterInstance;->updatePermissionsAsGranted(Ljava/util/Collection;)V
