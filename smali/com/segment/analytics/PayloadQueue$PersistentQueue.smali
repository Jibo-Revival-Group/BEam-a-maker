...
.method constructor <init>(Lcom/segment/analytics/QueueFile;)V
    .locals 0
    .param p1, "queueFile"    # Lcom/segment/analytics/QueueFile;
...
.method remove(I)V
    ...
    .line 71
    :try_start_0
    iget-object v1, p0, Lcom/segment/analytics/PayloadQueue$PersistentQueue;->queueFile:Lcom/segment/analytics/QueueFile;

    invoke-virtual {v1, p1}, Lcom/segment/analytics/QueueFile;->remove(I)V
    :try_end_0
