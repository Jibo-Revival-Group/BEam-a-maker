...
.method public beginTransaction()V
    ...
    .line 252
    iget-object v1, p0, Landroid/arch/persistence/room/RoomDatabase;->mOpenHelper:Landroid/arch/persistence/db/SupportSQLiteOpenHelper;
    ...
    .line 253
    .local v0, "database":Landroid/arch/persistence/db/SupportSQLiteDatabase;
...
.method public init(Landroid/arch/persistence/room/DatabaseConfiguration;)V
    ...
    iput-object v1, p0, Landroid/arch/persistence/room/RoomDatabase;->mOpenHelper:Landroid/arch/persistence/db/SupportSQLiteOpenHelper;
    ...
    .line 113
    iget-object v1, p1, Landroid/arch/persistence/room/DatabaseConfiguration;->journalMode:Landroid/arch/persistence/room/RoomDatabase$JournalMode;
    ...
    invoke-interface {v1, v0}, Landroid/arch/persistence/db/SupportSQLiteOpenHelper;->setWriteAheadLoggingEnabled(Z)V

    .line 116
    :cond_0
    iget-object v1, p1, Landroid/arch/persistence/room/DatabaseConfiguration;->callbacks:Ljava/util/List;

    iput-object v1, p0, Landroid/arch/persistence/room/RoomDatabase;->mCallbacks:Ljava/util/List;

    .line 117
    iget-boolean v1, p1, Landroid/arch/persistence/room/DatabaseConfiguration;->allowMainThreadQueries:Z

    iput-boolean v1, p0, Landroid/arch/persistence/room/RoomDatabase;->mAllowMainThreadQueries:Z

    .line 118
    iput-boolean v0, p0, Landroid/arch/persistence/room/RoomDatabase;->mWriteAheadLoggingEnabled:Z
...
.method public isOpen()Z
    ...
    .line 174
    .local v0, "db":Landroid/arch/persistence/db/SupportSQLiteDatabase;
    if-eqz v0, :cond_0
...
.method public query(Landroid/arch/persistence/db/SupportSQLiteQuery;)Landroid/database/Cursor;
    .locals 1
    .param p1, "query"    # Landroid/arch/persistence/db/SupportSQLiteQuery;
